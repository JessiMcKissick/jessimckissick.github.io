...
typewriter
    ...
    .typeString("<strong>Jessi_McKissick@github:~$</strong> ")
    .pauseFor('600')
    .typeString('certs and memberships')
    .pauseFor('200')
    .typeString('<br>')
    .typeString('<br>')
    .typeString('<div data-iframe-width="150" data-iframe-height="270" data-share-badge-id="cd6ad1ee-c9b5-41dc-bf05-90a711256782" data-share-badge-host="https://www.credly.com"></div>')
    .typeString('<br>')
    .typeString('<br>')
